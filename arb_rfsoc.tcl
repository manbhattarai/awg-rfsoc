...
\
  ...
  # Create instance: awg_BRAM_2CLKS_0, and set properties
  set block_name awg_BRAM_2CLKS
  set block_cell_name awg_BRAM_2CLKS_0
  if { [catch {set awg_BRAM_2CLKS_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $awg_BRAM_2CLKS_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create interface connections
  connect_bd_intf_net -intf_net awg_BRAM_2CLKS_0_m00_axis [get_bd_intf_pins awg_BRAM_2CLKS_0/m00_axis] [get_bd_intf_pins usp_rf_data_converter_0/s20_axis]
  ...
  connect_bd_net -net MAX_POINTS_gpio_io_o [get_bd_pins MAX_POINTS/gpio_io_o] [get_bd_pins awg_BRAM_2CLKS_0/MAX_POINTS]
  connect_bd_net -net col_gpio_io_o [get_bd_pins col/gpio_io_o] [get_bd_pins awg_BRAM_2CLKS_0/col]
  connect_bd_net -net data_in_gpio_io_o [get_bd_pins data_in/gpio_io_o] [get_bd_pins awg_BRAM_2CLKS_0/gpio_data_in]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins usp_rf_data_converter_0/s2_axis_aresetn]
  connect_bd_net -net row_gpio_io_o [get_bd_pins row/gpio_io_o] [get_bd_pins awg_BRAM_2CLKS_0/row]
